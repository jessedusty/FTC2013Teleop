...
#pragma config(Motor,  mtr_S1_C2_2,     robotLifter,   tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C1_1,     ringLifterLength, tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C1_2,     ringLifterAngle, tmotorTetrix, openLoop, encoder)
